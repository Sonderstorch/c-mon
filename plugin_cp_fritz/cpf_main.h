#ifndef CPF_MAIN_H_INCLUDED
#define CPF_MAIN_H_INCLUDED
...
class CCpfPlugin : public CCallMonitorPlugin
{
public:
  CCpfPlugin(IPluginRegistry *pApp);
  virtual ~CCpfPlugin();
