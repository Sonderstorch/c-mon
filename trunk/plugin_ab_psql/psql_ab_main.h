#ifndef PSQL_AB_MAIN_H_INCLUDED
#define PSQL_AB_MAIN_H_INCLUDED
...
class CPSQLAddressbookPlugin : public CAddressbookPlugin
{
public:
  CPSQLAddressbookPlugin(IPluginRegistry *pApp);
  virtual ~CPSQLAddressbookPlugin();
