#ifndef CPD_MAIN_H_INCLUDED
#define CPD_MAIN_H_INCLUDED
...
class CCpDummyPlugin : public CCallMonitorPlugin
{
public:
  CCpDummyPlugin(IPluginRegistry *pApp);
  virtual ~CCpDummyPlugin();
